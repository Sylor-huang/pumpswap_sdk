...
const getPoolsWithBaseMint = async (connection, mintAddress, poolAddress) => {
    if (poolAddress) {
...
const getPoolsWithPrices = async (connection, mintAddress, poolAddress) => {
...
const getBuyTokenAmount = async (connection, solAmount, mint, poolAddress) => {
